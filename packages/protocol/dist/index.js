...
__export(src_exports, {
  ...
  TCGProtocolImpl: () => TCGProtocolImpl,
  TemplateManager: () => TemplateManager,
  UnifiedAPIFactory: () => UnifiedAPIFactory,
  UpdateType: () => UpdateType,
  VERSION: () => VERSION,
  Web3Provider: () => Web3Provider,
  Web3ProviderFactory: () => Web3ProviderFactory,
  cardFilterEngine: () => cardFilterEngine,
  createTCGProtocol: () => createTCGProtocol
});
...
var Web3Provider = class {
  constructor(config) {
    ...
    if (config.provider) {
      ...
      this.provider = new import_ethers.ethers.JsonRpcProvider(networkConfig.rpcUrl);
    }
  }
  get isConnected() {
...
var RealtimeManager = class extends import_eventemitter3.EventEmitter {
  constructor(config) {
    super();
    __publicField(this, "config");
    __publicField(this, "subscriptions", /* @__PURE__ */ new Map());
  ...
  async disconnect() {
    ...
    switch (this.config.connectionType) {
      case "websocket" /* WEBSOCKET */:
        if (this.connection instanceof import_ws.default) {
  ...
  async initializeWebSocket() {
    return new Promise((resolve, reject) => {
      ...
      const ws = new import_ws.default(this.config.endpoint, {
  ...
  sendWebSocketMessage(message) {
    if (this.connection instanceof import_ws.default && this.connection.readyState === import_ws.default.OPEN) {
...
// src/sdk/tcg-protocol.ts
var TCGProtocolImpl = class extends import_eventemitter32.EventEmitter {
  constructor(config) {
    super();
    __publicField(this, "config");
